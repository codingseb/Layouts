//*****************************************************************************************************
// Copy from  : https://github.com/SpicyTaco/SpicyTaco.AutoGrid
...
namespace CodingSeb.Layouts
{
    ...
    public static class DependencyHelpers
    {
        ...
        {
            if (o == null) throw new ArgumentNullException(nameof(o), "DependencyObject cannot be null");
            if (property == null) throw new ArgumentNullException(nameof(property), "DependencyProperty cannot be null");
